...
export default function PageSection(props: SectionProps) {
	...
	switch (props.name) {
		...
		default:
			return <SmTxt>nextjs error 404</SmTxt>;
			break;
	}
	// return (
	// 	<Section
	...
	// 		</Icon>
	// 		{props.name === 'home' && (
	// 			<Article key={'home-pg-article'}>
	// 				{Array.isArray(props.content) &&
	// 					props.content.length >= 1 &&
	// 					props.content.map((articleContent: string, idx: number) => (
	// 						<MdTxt key={'home-pg-txt_' + idx}>{articleContent}</MdTxt>
	// 					))}
	// 			</Article>
	// 		)}
