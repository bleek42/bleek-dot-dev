import type { ID } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { String } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { Boolean } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { Int } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { Float } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { Date } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { DateTime } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { Hex } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { Json } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { Long } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { RGBAHue } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { RGBATransparency } from '/node_modules/graphql-scalars/esm/typeDefs.js';
import type { RichTextAST } from '/node_modules/graphql-scalars/esm/typeDefs.js';
...
export interface Asset extends Node {
  ...
  id: Scalars['ID'];
  /** System Locale field */
  locale: Locale | '%future added value';
  ...
  /** System stage field */
  stage: Stage | '%future added value';
...
export interface AssetUpdateLocalizationsInput {
  ...
  delete?: InputMaybe<Array<Locale | '%future added value'>>;
...
export interface AssetWhereStageInput {
  ...
  stage?: InputMaybe<Stage | '%future added value'>;
}
...
export interface DocumentOutputInput {
   ...
   */
  format?: InputMaybe<DocumentFileTypes | '%future added value'>;
}
...
export interface ImageResizeInput {
  ...
  fit?: InputMaybe<ImageFit | '%future added value'>;
...
export interface PublishLocaleInput {
  ...
  stages: Array<Stage | '%future added value'>;
}
...
export interface ScheduledOperation extends Node {
  ...
  stage: Stage | '%future added value';
  /** operation Status */
  status: ScheduledOperationStatus | '%future added value';
  /** The time the document was updated */
  updatedAt: Scalars['DateTime'];
  /** User that last updated this document */
  updatedBy?: Maybe<User>;
...
export interface ScheduledOperationManyWhereInput {
  ...
  status?: InputMaybe<ScheduledOperationStatus | '%future added value'>;
  /** All values that are contained in given list. */
  status_in?: InputMaybe<Array<InputMaybe<ScheduledOperationStatus | '%future added value'>>>;
  /** Any other value that exists and is not equal to the given value. */
  status_not?: InputMaybe<ScheduledOperationStatus | '%future added value'>;
  /** All values that are not contained in given list. */
  status_not_in?: InputMaybe<Array<InputMaybe<ScheduledOperationStatus | '%future added value'>>>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export interface ScheduledRelease extends Node {
  ...
  stage: Stage | '%future added value';
  /** Release Status */
  status: ScheduledReleaseStatus | '%future added value';
  /** Release Title */
...
export interface ScheduledReleaseManyWhereInput {
  ...
  status?: InputMaybe<ScheduledReleaseStatus | '%future added value'>;
  /** All values that are contained in given list. */
  status_in?: InputMaybe<Array<InputMaybe<ScheduledReleaseStatus | '%future added value'>>>;
  /** Any other value that exists and is not equal to the given value. */
  status_not?: InputMaybe<ScheduledReleaseStatus | '%future added value'>;
  /** All values that are not contained in given list. */
  status_not_in?: InputMaybe<Array<InputMaybe<ScheduledReleaseStatus | '%future added value'>>>;
  title?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  title_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
...
export interface User extends Node {
  ...
  kind: UserKind | '%future added value';
  /** The username */
  name: Scalars['String'];
  /** Profile Picture url */
...
export interface UserManyWhereInput {
  ...
  /** Any other value that exists and is not equal to the given value. */
  isActive_not?: InputMaybe<Scalars['Boolean']>;
  kind?: InputMaybe<UserKind | '%future added value'>;
  /** All values that are contained in given list. */
  kind_in?: InputMaybe<Array<InputMaybe<UserKind | '%future added value'>>>;
  /** Any other value that exists and is not equal to the given value. */
  kind_not?: InputMaybe<UserKind | '%future added value'>;
  /** All values that are not contained in given list. */
  kind_not_in?: InputMaybe<Array<InputMaybe<UserKind | '%future added value'>>>;
