...
`;
export const ProjectByTitleDocument = gql`
  query ProjectByTitle($title: String!) {
    project(where: { title: $title }) {
      id
      title
      description
      link
...
export function getSdk(
  ...
  return {
    ...
    ProjectByTitle(
      variables: ProjectByTitleQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<ProjectByTitleQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ProjectByTitleQuery>(
            ProjectByTitleDocument,
            variables,
