...
export type AssetWhereUniqueQuery = { __typename?: 'Query', asset?: { __typename?: 'Asset', id: string | number | symbol | unknown, fileName: string, handle: string, mimeType?: string | null, width?: number | null, height?: number | null, size?: number | null, url: string, locale: Types.Locale, createdAt: Date | string | symbol | unknown, updatedAt: Date | string | symbol | unknown, stage: Types.Stage } | null };
