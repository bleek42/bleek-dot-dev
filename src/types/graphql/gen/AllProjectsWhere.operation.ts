...
export type AllProjectsWhereQuery = { __typename?: 'Query', projects: Array<{ __typename?: 'Project', id: string | number | symbol | unknown, title: string, active: boolean, link: string, description: string, version: number, sourceCode: Array<string>, techStack?: string[] | string | symbol | unknown | null, stage: Types.Stage, locale: Types.Locale, screenShots: Array<{ __typename?: 'Asset', id: string | number | symbol | unknown, url: string, handle: string, fileName: string, mimeType?: string | null, width?: number | null, height?: number | null, size?: number | null, stage: Types.Stage, locale: Types.Locale }> }> };
