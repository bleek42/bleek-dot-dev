import type { ID } from 'Date, DateTime, URL, JSON';
import type { String } from 'Date, DateTime, URL, JSON';
import type { Boolean } from 'Date, DateTime, URL, JSON';
import type { Int } from 'Date, DateTime, URL, JSON';
import type { Float } from 'Date, DateTime, URL, JSON';
import type { Date } from 'Date, DateTime, URL, JSON';
import type { DateTime } from 'Date, DateTime, URL, JSON';
import type { Hex } from 'Date, DateTime, URL, JSON';
import type { Json } from 'Date, DateTime, URL, JSON';
import type { Long } from 'Date, DateTime, URL, JSON';
import type { RGBAHue } from 'Date, DateTime, URL, JSON';
import type { RGBATransparency } from 'Date, DateTime, URL, JSON';
import type { RichTextAST } from 'Date, DateTime, URL, JSON';
import type { GraphQLClient } from 'graphql-request';
import type * as Dom from 'graphql-request/dist/types.dom';
import gql from 'graphql-tag';
import { ProjectCreateMutationVariables, ProjectCreateMutation } from '../graphCMS/typeDefs';
...
export type Asset = Node & {
  ...
  documentInStages: Array<FieldWrapper<Asset>>;
  /** The file name */
  fileName: FieldWrapper<Scalars['String']>;
  /** The file handle */
  handle: FieldWrapper<Scalars['String']>;
  /** The height of the file */
  height?: Maybe<FieldWrapper<Scalars['Float']>>;
  /** List of Asset versions */
  history: Array<FieldWrapper<Version>>;
  /** The unique identifier */
  id: FieldWrapper<Scalars['ID']>;
  /** System Locale field */
  locale: FieldWrapper<Locale>;
  /** Get the other localizations for this document */
  localizations: Array<FieldWrapper<Asset>>;
  /** The mime type of the file */
  mimeType?: Maybe<FieldWrapper<Scalars['String']>>;
  /** The time the document was published. Null on documents in draft stage. */
  publishedAt?: Maybe<FieldWrapper<Scalars['DateTime']>>;
  /** User that last published this document */
  publishedBy?: Maybe<FieldWrapper<User>>;
  scheduledIn: Array<FieldWrapper<ScheduledOperation>>;
  screenShotsProject: Array<FieldWrapper<Project>>;
  /** The file size */
  size?: Maybe<FieldWrapper<Scalars['Float']>>;
  /** System stage field */
  stage: FieldWrapper<Stage>;
  /** The time the document was updated */
  updatedAt: FieldWrapper<Scalars['DateTime']>;
  /** User that last updated this document */
  updatedBy?: Maybe<FieldWrapper<User>>;
...
/** Asset system model */
export type AssetScreenShotsProjectArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type AssetConnection = {
  ...
  aggregate: FieldWrapper<Aggregate>;
  /** A list of edges. */
  edges: Array<FieldWrapper<AssetEdge>>;
...
export type AssetCreateInput = {
  ...
  screenShotsProject?: InputMaybe<ProjectCreateManyInlineInput>;
...
export type AssetManyWhereInput = {
  ...
  screenShotsProject_every?: InputMaybe<ProjectWhereInput>;
  screenShotsProject_none?: InputMaybe<ProjectWhereInput>;
  screenShotsProject_some?: InputMaybe<ProjectWhereInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
...
export type AssetUpdateInput = {
  ...
  mimeType?: InputMaybe<Scalars['String']>;
  screenShotsProject?: InputMaybe<ProjectUpdateManyInlineInput>;
  size?: InputMaybe<Scalars['Float']>;
  width?: InputMaybe<Scalars['Float']>;
};
...
export type BatchPayload = {
  ...
  count: FieldWrapper<Scalars['Long']>;
};

/** Representing a color value comprising of HEX, RGBA and css color values */
export type Color = {
  __typename?: 'Color';
  css: FieldWrapper<Scalars['String']>;
  hex: FieldWrapper<Scalars['Hex']>;
  rgba: FieldWrapper<Rgba>;
};
...
export type DocumentVersion = {
  ...
  id: FieldWrapper<Scalars['ID']>;
  revision: FieldWrapper<Scalars['Int']>;
  stage: FieldWrapper<Stage>;
};
...
export type Location = {
  ...
  latitude: FieldWrapper<Scalars['Float']>;
  longitude: FieldWrapper<Scalars['Float']>;
};
...
export type Mutation = {
   ...
   */
  createAsset?: Maybe<FieldWrapper<Asset>>;
  /** Create one project */
  createProject?: Maybe<FieldWrapper<Project>>;
  /** Create one scheduledRelease */
  createScheduledRelease?: Maybe<FieldWrapper<ScheduledRelease>>;
  /** Delete one asset from _all_ existing stages. Returns deleted document. */
  deleteAsset?: Maybe<FieldWrapper<Asset>>;
  /**
   * Delete many Asset documents
   * @deprecated Please use the new paginated many mutation (deleteManyAssetsConnection)
   */
  deleteManyAssets: FieldWrapper<BatchPayload>;
  /** Delete many Asset documents, return deleted documents */
  deleteManyAssetsConnection: FieldWrapper<AssetConnection>;
  /**
   * Delete many Project documents
   * @deprecated Please use the new paginated many mutation (deleteManyProjectsConnection)
   */
  deleteManyProjects: FieldWrapper<BatchPayload>;
  /** Delete many Project documents, return deleted documents */
  deleteManyProjectsConnection: FieldWrapper<ProjectConnection>;
  /** Delete one project from _all_ existing stages. Returns deleted document. */
  deleteProject?: Maybe<FieldWrapper<Project>>;
  /** Delete and return scheduled operation */
  deleteScheduledOperation?: Maybe<FieldWrapper<ScheduledOperation>>;
  /** Delete one scheduledRelease from _all_ existing stages. Returns deleted document. */
  deleteScheduledRelease?: Maybe<FieldWrapper<ScheduledRelease>>;
  /** Publish one asset */
  publishAsset?: Maybe<FieldWrapper<Asset>>;
  /**
   * Publish many Asset documents
   * @deprecated Please use the new paginated many mutation (publishManyAssetsConnection)
   */
  publishManyAssets: FieldWrapper<BatchPayload>;
  /** Publish many Asset documents */
  publishManyAssetsConnection: FieldWrapper<AssetConnection>;
  /**
   * Publish many Project documents
   * @deprecated Please use the new paginated many mutation (publishManyProjectsConnection)
   */
  publishManyProjects: FieldWrapper<BatchPayload>;
  /** Publish many Project documents */
  publishManyProjectsConnection: FieldWrapper<ProjectConnection>;
  /** Publish one project */
  publishProject?: Maybe<FieldWrapper<Project>>;
  /** Schedule to publish one asset */
  schedulePublishAsset?: Maybe<FieldWrapper<Asset>>;
  /** Schedule to publish one project */
  schedulePublishProject?: Maybe<FieldWrapper<Project>>;
  /** Unpublish one asset from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  scheduleUnpublishAsset?: Maybe<FieldWrapper<Asset>>;
  /** Unpublish one project from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  scheduleUnpublishProject?: Maybe<FieldWrapper<Project>>;
  /** Unpublish one asset from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishAsset?: Maybe<FieldWrapper<Asset>>;
  /**
   * Unpublish many Asset documents
   * @deprecated Please use the new paginated many mutation (unpublishManyAssetsConnection)
   */
  unpublishManyAssets: FieldWrapper<BatchPayload>;
  /** Find many Asset documents that match criteria in specified stage and unpublish from target stages */
  unpublishManyAssetsConnection: FieldWrapper<AssetConnection>;
  /**
   * Unpublish many Project documents
   * @deprecated Please use the new paginated many mutation (unpublishManyProjectsConnection)
   */
  unpublishManyProjects: FieldWrapper<BatchPayload>;
  /** Find many Project documents that match criteria in specified stage and unpublish from target stages */
  unpublishManyProjectsConnection: FieldWrapper<ProjectConnection>;
  /** Unpublish one project from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishProject?: Maybe<FieldWrapper<Project>>;
  /** Update one asset */
  updateAsset?: Maybe<FieldWrapper<Asset>>;
  /**
   * Update many assets
   * @deprecated Please use the new paginated many mutation (updateManyAssetsConnection)
   */
  updateManyAssets: FieldWrapper<BatchPayload>;
  /** Update many Asset documents */
  updateManyAssetsConnection: FieldWrapper<AssetConnection>;
  /**
   * Update many projects
   * @deprecated Please use the new paginated many mutation (updateManyProjectsConnection)
   */
  updateManyProjects: FieldWrapper<BatchPayload>;
  /** Update many Project documents */
  updateManyProjectsConnection: FieldWrapper<ProjectConnection>;
  /** Update one project */
  updateProject?: Maybe<FieldWrapper<Project>>;
  /** Update one scheduledRelease */
  updateScheduledRelease?: Maybe<FieldWrapper<ScheduledRelease>>;
  /** Upsert one asset */
  upsertAsset?: Maybe<FieldWrapper<Asset>>;
  /** Upsert one project */
  upsertProject?: Maybe<FieldWrapper<Project>>;
};
...
export type PageInfo = {
  ...
  pageSize?: Maybe<FieldWrapper<Scalars['Int']>>;
...
export type Project = Node & {
  ...
  /** User that created this document */
  createdBy?: Maybe<FieldWrapper<User>>;
  /** First stable version release date. */
  dateReleased: FieldWrapper<Scalars['Date']>;
  /** Last day an update was made. */
  dateUpdated?: Maybe<FieldWrapper<Scalars['Date']>>;
  /** Tell everyone what this project is and what it does. */
  description: FieldWrapper<Scalars['String']>;
  /** Get the document in other stages */
  documentInStages: Array<FieldWrapper<Project>>;
  ...
  locale: FieldWrapper<Locale>;
  /** Get the other localizations for this document */
  localizations: Array<FieldWrapper<Project>>;
  /** The time the document was published. Null on documents in draft stage. */
  publishedAt?: Maybe<FieldWrapper<Scalars['DateTime']>>;
  /** User that last published this document */
  publishedBy?: Maybe<FieldWrapper<User>>;
  ...
  screenShots: Array<FieldWrapper<Asset>>;
  /** URL or list of URL's that link to where the project's source code can be found. */
  sourceCode: Array<FieldWrapper<Scalars['String']>>;
  /** System stage field */
  stage: FieldWrapper<Stage>;
  ...
  techStack?: Maybe<FieldWrapper<Scalars['Json']>>;
  /** Title of a Project */
  ...
  updatedBy?: Maybe<FieldWrapper<User>>;
  /** Current app version. */
  version: FieldWrapper<Scalars['Float']>;
};
...
export type ProjectCreateInput = {
  ...
  createdAt?: InputMaybe<Scalars['DateTime']>;
  dateReleased: Scalars['Date'];
  dateUpdated?: InputMaybe<Scalars['Date']>;
...
export type ProjectManyWhereInput = {
  ...
  createdAt_not_in?: InputMaybe<Array<Scalars['DateTime']>>;
  createdBy?: InputMaybe<UserWhereInput>;
  dateReleased?: InputMaybe<Scalars['Date']>;
  /** All values greater than the given value. */
  dateReleased_gt?: InputMaybe<Scalars['Date']>;
  /** All values greater than or equal the given value. */
  dateReleased_gte?: InputMaybe<Scalars['Date']>;
  /** All values that are contained in given list. */
  dateReleased_in?: InputMaybe<Array<Scalars['Date']>>;
  /** All values less than the given value. */
  dateReleased_lt?: InputMaybe<Scalars['Date']>;
  /** All values less than or equal the given value. */
  dateReleased_lte?: InputMaybe<Scalars['Date']>;
  /** All values that are not equal to given value. */
  dateReleased_not?: InputMaybe<Scalars['Date']>;
  /** All values that are not contained in given list. */
  dateReleased_not_in?: InputMaybe<Array<Scalars['Date']>>;
  dateUpdated?: InputMaybe<Scalars['Date']>;
  /** All values greater than the given value. */
  dateUpdated_gt?: InputMaybe<Scalars['Date']>;
  /** All values greater than or equal the given value. */
  dateUpdated_gte?: InputMaybe<Scalars['Date']>;
  /** All values that are contained in given list. */
  dateUpdated_in?: InputMaybe<Array<Scalars['Date']>>;
  /** All values less than the given value. */
  dateUpdated_lt?: InputMaybe<Scalars['Date']>;
  /** All values less than or equal the given value. */
  dateUpdated_lte?: InputMaybe<Scalars['Date']>;
  /** All values that are not equal to given value. */
  dateUpdated_not?: InputMaybe<Scalars['Date']>;
  /** All values that are not contained in given list. */
  dateUpdated_not_in?: InputMaybe<Array<Scalars['Date']>>;
...
export enum ProjectOrderByInput {
  ...
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  DateReleasedAsc = 'dateReleased_ASC',
  DateReleasedDesc = 'dateReleased_DESC',
  DateUpdatedAsc = 'dateUpdated_ASC',
  DateUpdatedDesc = 'dateUpdated_DESC',
...
export type Query = {
  ...
  asset?: Maybe<FieldWrapper<Asset>>;
  /** Retrieve document version */
  assetVersion?: Maybe<FieldWrapper<DocumentVersion>>;
  /** Retrieve multiple assets */
  assets: Array<FieldWrapper<Asset>>;
  /** Retrieve multiple assets using the Relay connection interface */
  assetsConnection: FieldWrapper<AssetConnection>;
  /** Fetches an object given its ID */
  node?: Maybe<FieldWrapper<Asset | Project | ScheduledOperation | ScheduledRelease | User>>;
  /** Retrieve a single project */
  project?: Maybe<FieldWrapper<Project>>;
  /** Retrieve document version */
  projectVersion?: Maybe<FieldWrapper<DocumentVersion>>;
  /** Retrieve multiple projects */
  projects: Array<FieldWrapper<Project>>;
  /** Retrieve multiple projects using the Relay connection interface */
  projectsConnection: FieldWrapper<ProjectConnection>;
  /** Retrieve a single scheduledOperation */
  scheduledOperation?: Maybe<FieldWrapper<ScheduledOperation>>;
  /** Retrieve multiple scheduledOperations */
  scheduledOperations: Array<FieldWrapper<ScheduledOperation>>;
  /** Retrieve multiple scheduledOperations using the Relay connection interface */
  scheduledOperationsConnection: FieldWrapper<ScheduledOperationConnection>;
  /** Retrieve a single scheduledRelease */
  scheduledRelease?: Maybe<FieldWrapper<ScheduledRelease>>;
  /** Retrieve multiple scheduledReleases */
  scheduledReleases: Array<FieldWrapper<ScheduledRelease>>;
  /** Retrieve multiple scheduledReleases using the Relay connection interface */
  scheduledReleasesConnection: FieldWrapper<ScheduledReleaseConnection>;
  /** Retrieve a single user */
  user?: Maybe<FieldWrapper<User>>;
  /** Retrieve multiple users */
  users: Array<FieldWrapper<User>>;
  /** Retrieve multiple users using the Relay connection interface */
  usersConnection: FieldWrapper<UserConnection>;
};
...
export type Rgba = {
  __typename?: 'RGBA';
  a: FieldWrapper<Scalars['RGBATransparency']>;
  b: FieldWrapper<Scalars['RGBAHue']>;
  g: FieldWrapper<Scalars['RGBAHue']>;
  r: FieldWrapper<Scalars['RGBAHue']>;
};
...
export type RichText = {
  ...
  markdown: FieldWrapper<Scalars['String']>;
  /** Returns AST representation */
  raw: FieldWrapper<Scalars['RichTextAST']>;
...
export type ScheduledOperation = Node & {
  ...
  affectedDocuments: Array<FieldWrapper<ScheduledOperationAffectedDocument>>;
  /** The time the document was created */
  createdAt: FieldWrapper<Scalars['DateTime']>;
  /** User that created this document */
  createdBy?: Maybe<FieldWrapper<User>>;
  ...
  /** Get the document in other stages */
  documentInStages: Array<FieldWrapper<ScheduledOperation>>;
  ...
  rawPayload: FieldWrapper<Scalars['Json']>;
  /** The release this operation is scheduled for */
  release?: Maybe<FieldWrapper<ScheduledRelease>>;
  /** System stage field */
  stage: FieldWrapper<Stage>;
  /** operation Status */
  status: FieldWrapper<ScheduledOperationStatus>;
  /** The time the document was updated */
  updatedAt: FieldWrapper<Scalars['DateTime']>;
  /** User that last updated this document */
  updatedBy?: Maybe<FieldWrapper<User>>;
...
export type ScheduledOperationConnection = {
  ...
  aggregate: FieldWrapper<Aggregate>;
  /** A list of edges. */
  edges: Array<FieldWrapper<ScheduledOperationEdge>>;
  /** Information to aid in pagination. */
  pageInfo: FieldWrapper<PageInfo>;
};
...
export type ScheduledOperationEdge = {
  ...
  cursor: FieldWrapper<Scalars['String']>;
  /** The item at the end of the edge. */
  node: FieldWrapper<ScheduledOperation>;
};
...
export type ScheduledRelease = Node & {
  ...
  description?: Maybe<FieldWrapper<Scalars['String']>>;
  /** Get the document in other stages */
  documentInStages: Array<FieldWrapper<ScheduledRelease>>;
  ...
  isImplicit: FieldWrapper<Scalars['Boolean']>;
  /** Operations to run with this release */
  operations: Array<FieldWrapper<ScheduledOperation>>;
  /** The time the document was published. Null on documents in draft stage. */
  publishedAt?: Maybe<FieldWrapper<Scalars['DateTime']>>;
  /** User that last published this document */
  publishedBy?: Maybe<FieldWrapper<User>>;
  /** Release date and time */
  releaseAt?: Maybe<FieldWrapper<Scalars['DateTime']>>;
  /** System stage field */
  stage: FieldWrapper<Stage>;
  /** Release Status */
  status: FieldWrapper<ScheduledReleaseStatus>;
  /** Release Title */
...
export type ScheduledReleaseConnection = {
  ...
  aggregate: FieldWrapper<Aggregate>;
  /** A list of edges. */
  edges: Array<FieldWrapper<ScheduledReleaseEdge>>;
  /** Information to aid in pagination. */
  pageInfo: FieldWrapper<PageInfo>;
};
...
export type ScheduledReleaseEdge = {
  ...
  cursor: FieldWrapper<Scalars['String']>;
  /** The item at the end of the edge. */
  node: FieldWrapper<ScheduledRelease>;
};
...
export type User = Node & {
  ...
  createdAt: FieldWrapper<Scalars['DateTime']>;
  /** Get the document in other stages */
  documentInStages: Array<FieldWrapper<User>>;
  /** The unique identifier */
  id: FieldWrapper<Scalars['ID']>;
  /** Flag to determine if user is active or not */
  isActive: FieldWrapper<Scalars['Boolean']>;
  /** User Kind. Can be either MEMBER, PAT or PUBLIC */
  kind: FieldWrapper<UserKind>;
  /** The username */
    ...
    ProjectCreate(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ProjectCreateMutation>(ProjectCreateDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'ProjectCreate',
